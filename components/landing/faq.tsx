            ...
            <div className="bg-gradient-to-br from-teal-50 to-teal-100/50 rounded-2xl p-6 sm:p-8 border border-teal-100 text-right">
              ...
              <div className="flex flex-col sm:flex-row gap-3 justify-center items-center">
                <a
                  ...
                  className="inline-flex items-center justify-center gap-2 bg-[#25D366] hover:bg-[#20bd5a] text-white px-6 py-3 rounded-xl font-semibold shadow-md hover:shadow-lg transition-all min-w-[180px]"
                >
