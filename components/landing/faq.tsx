    ...
    >
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        >
          ...
          <div className="space-y-3 sm:space-y-4">
            {displayQuestions.map((faq, index) => (
              <motion.div
                ...
                transition={{ duration: 0.45, delay: 0.15 + index * 0.07, ease: [0.25, 0.1, 0.25, 1] }}
          ...
          >
            <div className="faq-cta-box bg-gradient-to-br from-teal-50 to-teal-100/50 rounded-2xl p-6 sm:p-8 border border-teal-100 text-right">
              <h3 className="faq-cta-heading text-lg sm:text-xl font-bold text-slate-900 mb-2">
                {ctaHeading}
              </h3>
              <p className="faq-cta-subtext text-slate-600 mb-5 max-w-xl mx-auto">
                {ctaText}
              </p>
              <div className="flex flex-col sm:flex-row gap-3 justify-center items-center">
                <a
                  ...
                  className="faq-whatsapp-btn inline-flex items-center justify-center gap-2 bg-[#25D366] hover:bg-[#20bd5a] text-white px-6 py-3 rounded-xl font-semibold shadow-md hover:shadow-lg transition-all min-w-[180px]"
                >
                ...
                <motion.button
                  ...
                  className="inline-flex items-center justify-center gap-2 bg-gradient-to-r from-teal-600 to-teal-500 hover:from-teal-500 hover:to-teal-400 text-white px-6 py-3 rounded-xl font-semibold shadow-md transition-all min-w-[180px]"
