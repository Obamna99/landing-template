        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <h3 className="text-xl font-bold text-white">{previewBranding?.siteName ?? siteConfig.name}</h3>
                <p className="text-sm text-slate-400">{previewBranding?.tagline ?? siteConfig.tagline}</p>
              </div>
            </div>
