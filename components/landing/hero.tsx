...
// Rotating text words - Hebrew success verbs
        ...
        >
          ...
          <div className="relative">
            <h2 className="text-xl sm:text-2xl font-bold text-slate-900 mb-4 text-center">
              מה תקבלו? 
              <span className="text-teal-600"> הכל כלול.</span>
            </h2>
              ...
              {[
                {
                  ...
                  description: "תכנית פעולה מדויקת עם יעדים ברורים",
                },
                {
                  icon: (
                    <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  title: "ביצוע מקצועי",
                  description: "צוות מנוסה שמתחיל לעבוד מיידית",
                },
                {
                  icon: (
                    <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  title: "צמיחה מדידה",
                  description: "תוצאות שקופות ואופטימיזציה מתמדת",
                },
              ].map((feature, index) => (
                <motion.div
                  key={feature.title}
        ...
        >
          ...
          >
            ...
            <span className="text-sm font-medium text-amber-800">
              נותרו <span className="font-bold">{spotsLeft} מקומות</span> לחודש הקרוב
            </span>
          </motion.div>
          ...
          >
            ...
            שיחת היכרות ללא עלות • ללא התחייבות
          </motion.p>
        </motion.div>
      </div>
